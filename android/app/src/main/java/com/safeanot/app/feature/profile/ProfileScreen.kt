...
fun ProfileScreen(
    ...
    val unlockedBadgeCount by viewModel.unlockedBadgeCount.collectAsStateWithLifecycle()
            ...
            Card(
                ...
                Row(
                    ...
                    Column(modifier = Modifier.weight(1f)) {
                        ...
                        Spacer(modifier = Modifier.height(4.dp))
                        Text(
                            text = if (uiState.guardianCount > 0) {
                                "${uiState.guardianCount} active pairing(s)"
                            } else {
                                "Help protect your family members"
                            },
                ...
                Row(
                    ...
                    Row(
                        ...
                        Column {
                            ...
                            Spacer(modifier = Modifier.height(4.dp))
                            Text(
                                text = "$unlockedBadgeCount badges earned",
                                style = MaterialTheme.typography.bodySmall,
                                color = TextSecondary,
                            )
                        }
